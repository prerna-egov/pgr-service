...
public class ServiceConstants {
    ...
    public static String USERTYPE_EMPLOYEE = "EMPLOYEE";
    public static final String MDMS_MASTER_SERVICEDEF = "ServiceDefs";
    public static final String MDMS_MODULE_NAME_RAINMAKER_PGR = "RAINMAKER-PGR";
